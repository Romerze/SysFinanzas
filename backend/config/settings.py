...
SECRET_KEY = 'django-insecure-wj1_nbhqbo#8rn%-^2y)ux21pb@d8s-3$obtw!fo2y58@-q%3y'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173", # Puerto del frontend Vite (anterior)
    "http://127.0.0.1:5173",
    "http://localhost:5174", # Nuevo puerto del frontend Vite
    "http://127.0.0.1:5174",
    "http://localhost:5175", # Nuevo puerto del frontend Vite
    "http://127.0.0.1:5175",
    "http://localhost:5176", # Nuevo puerto del frontend Vite
    "http://127.0.0.1:5176",
]
...
# Opcional: Si necesitas permitir métodos específicos o cabeceras
# CORS_ALLOW_METHODS = [
#     'DELETE',
#     'GET',
#     'OPTIONS',
